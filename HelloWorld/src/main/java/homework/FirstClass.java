...
public class FirstClass {
    public static void main(String[] args) {
       ...
       /* Jāuzraksta dažus teikumus uz brīvu tēmu
        ...
        if (isCountryEuMember) {System.out.printf("Is Latvia a EU member state? Yes, it's %b%n", isCountryEuMember);
        } else {System.out.printf("Is Latvia a EU member state? No, it's %b%n", isCountryEuMember);}
        // 3. teikums (ar konkatenāciju)
        if (isCountryEuMember) {System.out.println("Is Latvia a EU member state? Yes, it's "+isCountryEuMember);
        } else {System.out.println("Is Latvia a EU member state? No, it's "+isCountryEuMember);}
        ...
        */
        ...
        for (int i = 0; i < 3; i++) {System.out.println("Hey! My number is "+i);}
        ...
        //4.1. piemērs (minus)
        System.out.println("Piecpadsmit mīnus desmit ir " + Integer.toString(15-10));
        //4.2. piemērs (minus)
        switch(4-2) {
            case 1:
                System.out.printf("Four minus two is %d%n",1); break;
            case 2:
                System.out.printf("Four minus two is %d%n",2); break;
            default:
                System.out.println("error"); break;
        }
        //4.3. piemērs (minus)
        System.out.printf("1 minus 2 is %s", Integer.toString(1-2));
    }
}
